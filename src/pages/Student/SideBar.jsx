            ...
            <div className='w-full bg-gradient-to-b from-slate-800 to-slate-900 flex flex-col text-white p-6 items-center justify-center h-full gap-8 rounded-xl shadow-2xl mt-2 animate-slideInUp'>
                ...
                >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xs text-gray-500">ID: S001</p>
                    </div>
                </Link>
                ...
                {/* Logout Button */}
                <div className='flex flex-row items-center justify-center gap-3 cursor-pointer mt-auto bg-red-500 hover:bg-red-600 p-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-slideInUp' style={{animationDelay: '0.8s'}}>
