...
function About() {
  ...
  return (
    <div id="about" className="bg-gradient-to-br from-gray-50 to-blue-50 text-gray-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 gap-10 flex flex-col relative z-10">
        <div className="text-center mb-12 animate-fadeIn">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-700 mx-auto rounded-full animate-slideInUp" style={{animationDelay: '0.2s'}}></div>
        </div>

        {/* Flex container responsive */}
        <div className="flex flex-col md:flex-row items-center gap-12 animate-slideInUp" style={{animationDelay: '0.3s'}}>
          {/* Text Content */}
          <div className="w-full md:w-1/2">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20">
              <p className={`text-lg md:text-xl text-gray-700 mb-6 leading-relaxed ${language === 'ar' ? 'font-arabic' : ''}`}>
          ...
          {/* Image */}
          <div className="w-full md:w-1/2 flex justify-center animate-slideInUp" style={{animationDelay: '0.4s'}}>
      ...
      <section className="py-16 px-6 bg-white/50 backdrop-blur-sm relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-12 animate-fadeIn">
            <h2 className={`text-3xl md:text-4xl font-bold mb-4 text-gray-800 animate-slideInDown ${language === 'ar' ? 'font-arabic' : ''}`}>Our Services</h2>
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-gray-600 text-base leading-relaxed">{service.text}</p>
              </div>
            ))}
          </div>
        </div>
